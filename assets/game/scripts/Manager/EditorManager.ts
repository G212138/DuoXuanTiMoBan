...
export class GameData {
    ...
    public opinion: number = 0; //选项数量，数量为2~8个
    public answerId: number[] = []; //正确答案的id；
    public answer: opinionPara[] = []; //多个正确答案的id；
}

export class opinionPara {
    public id :number = 0; //选项id
    public opinionText : string = ""; //选项的文本，最多10个字；
    public opinionPic : string = ""; //选项的图片，总选项的数量会影响分辨率的尺寸，当同时配置了文本和图片时，只显示图片；
}
